...
[![ ](/assets/media/image/media/image/Android应用安全开发之防范无意识的数据泄露1.jpg)](/assets/media/image/media/image/Android应用安全开发之防范无意识的数据泄露1.jpg)

发起录制请求后，系统弹出如下提示框请求用户确认：

[![ ](/assets/media/image/media/image/Android应用安全开发之防范无意识的数据泄露2.jpg)](/assets/media/image/media/image/Android应用安全开发之防范无意识的数据泄露2.jpg)
